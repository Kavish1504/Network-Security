...
from networksecurity.entity.config_entity import DataTransformationnConfig
from networksecurity.utils.main_utils.utils import save_numpy_array_data,save_object

class DataTransformation:
    def __init__(self,data_validation_artifact:DataValidationArtifact,data_transformation_config:DataTransformationnConfig):
        try:
            self.data_validation_artifact:DataValidationArtifact=data_validation_artifact
            self.data_transformation_config:DataTransformationnConfig=data_transformation_config
    ...
    def get_data_transformer_object(cls)->Pipeline:
        logging.info("Entered Pipeline Transformation function")
        try:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("Entered initiate data transformation function")
        try:
           ...
           datatransformationartifact=DataTransformationArtifact(
               self.data_transformation_config.tranformed_object_file_path,
